...
TEST(types_test, usize) {
  static_assert(std::same_as<ctl::usize, ctl::core::usize>);
...
TEST(types_test, isize) {
  static_assert(std::same_as<ctl::isize, ctl::core::isize>);
